build-projects:
	make -C projects docker-build

build: build-projects
	make -C presentation/01-package-deb docker-build && \
	make -C presentation/01-package-docker docker-build && \
	make -C presentation/02-delivery-deb docker-build && \
...
push: push-projects
	make -C presentation/01-package-deb docker-push && \
	make -C presentation/01-package-docker docker-push && \
